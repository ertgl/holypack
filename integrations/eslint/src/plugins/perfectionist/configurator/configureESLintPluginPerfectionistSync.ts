...
export function configureESLintPluginPerfectionistSync(
...
): void
{
  ...
  const pluginPerfectionist = suppressErrorSync(
    requireDefaultExport<typeof ESLintPluginPerfectionist>,
    require,
